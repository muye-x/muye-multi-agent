...
> 当前阶段：阶段 3 - Generator 与开发者工作流（待开始）
> 更新日期：2026-07-30
...
- Knowledge/Profile 到 GenerationSpec 的可信组装。
- 原子目录生成、provenance、source checksum、validate 和 diff。
- 路径/symlink/覆盖保护与 golden tests。
- `scripts/muye.sh knowledge ...` 和 `agent generate/validate`。
- README、模板迁移和开发者接管文档。
